...
export const producerProfileQueryKey = businessId => ['producerProfile', businessId];
...
export const useProducerProfileQuery = (businessId, options = {}) => useQuery({
...
export const useUpdateProfileMutation = (options = {}) => useMutation({
...
export const updateProfileOptions = async updateObj => {
  const privateRoute = await getPrivateRoute();
  const response = await privateRoute.patch('/producer/profile/options', updateObj);
  return response.data;
};

export const useUpdateProfileOptionsMutation = (options = {}) => useMutation({
...
export const useSendOrderMutation = (options = {}) => useMutation({
...
export const usePostBlogMutation = (options = {}) => useMutation({
  mutationFn: postBlog,
  ...options,
});
...
export const useEditBlogMutation = (options = {}) => useMutation({
  mutationFn: editBlog,
  ...options,
});
...
export const useUpdateStockMutation = (options = {}) => useMutation({
...
export const addPromotion = async promotionAddData => {
  const privateRoute = await getPrivateRoute();
  const response = await privateRoute.post('/producer/promotion', promotionAddData);
  return response.data;
};

export const useAddPromotionMutation = (options = {}) => useMutation({
...
export const deletePromotion = async promotionId => {
  const privateRoute = await getPrivateRoute();
  const response = await privateRoute.delete(`/producer/promotion/${promotionId}`);
  return response.data;
};

export const useDeletePromotionMutation = (options = {}) => useMutation({
